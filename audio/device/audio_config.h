...
//for AIC8800, I2S MCLK can select GPIO A15, A4
#define AUDIO_CFG_I2S_MCLK_PIN              PA_15
//#define AUDIO_CFG_I2S_MCLK_PIN              PA_4
#elif PLF_AIC8800MC
#define AUDIO_CFG_DEVICE                    AUD_DEVICE_EXT_CODEC_I2S0

//for AIC8800MC, I2S MCLK can select GPIO A13, A4
#define AUDIO_CFG_I2S_MCLK_PIN              PA_13
//#define AUDIO_CFG_I2S_MCLK_PIN              PA_4
#elif PLF_AIC8800M40
#define AUDIO_CFG_DEVICE                    AUD_DEVICE_EXT_CODEC_I2S1

// for AIC8800M40, I2S MCLK can select GPIO A11, A5, A2
#define AUDIO_CFG_I2S_MCLK_PIN              PA_11
//#define AUDIO_CFG_I2S_MCLK_PIN              PA_5
//#define AUDIO_CFG_I2S_MCLK_PIN              PA_2
#endif
...
#ifndef AUDIO_CFG_EXT_AIC1000_I2S_IDX
#define AUDIO_CFG_I2S_MCLK_PIN              PIN_NC
#endif
...
uint8_t audio_config_i2s_mclk_pin_get(void);
