...
NOTE: Make sure you copy the section with text "CM4 Fault Handler" as the this tool looks for that header.
...
For example:
crash_log_parser.py crash.log build/basic-rtos-aic8800m40/host_wb_aic8800m40.elf build/basic-rtos-aic8800m40/linkmap.armgcc_4_8.txt
