...
#endif
typedef uint32_t (*task_suspend_func_cb)(void);
typedef void (*task_resume_func_cb)(bool isr,uint32_t value);
typedef void (*dut_cb_t)(uint32_t len, const uint8_t* data);
