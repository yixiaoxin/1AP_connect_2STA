...
#define MSADC_REG_CFG_ANA_MSADC_VCOM_BIT(n)      (((n)&3)<<25)
#define MSADC_REG_CFG_ANA_MSADC_VCOM_BIT_LSB     (25)
#define MSADC_REG_CFG_ANA_MSADC_VCOM_BIT_MASK    (3<<25)
#define MSADC_REG_CFG_ANA_MSADC_DITHER_MODE(n)      (((n)&3)<<27)
#define MSADC_REG_CFG_ANA_MSADC_DITHER_MODE_LSB     (27)
#define MSADC_REG_CFG_ANA_MSADC_DITHER_MODE_MASK    (3<<27)
