...
unsigned int flash_func_unique_id_read[] = {
    0x2b1f1e4b,
    0x2a00d83a,
    0xb470d035,
    0x2800b083,
...
{
    critical_section_start();
    ((void (*)(unsigned int, unsigned int, unsigned int))((unsigned int)(&flash_func_unique_id_read[0]) + 0x1UL))(dc_cfg, len, (unsigned int)buf);
    critical_section_end();
}
...
#if defined(CFG_DYNAMIC_DPD)
#define FLASH_DPD_RES_SECTOR_CNT    (21)
#else
#define FLASH_DPD_RES_SECTOR_CNT    (0)
#endif
