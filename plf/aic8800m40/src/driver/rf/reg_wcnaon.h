...
/**
 * @name BT_WAKEUP_REMAIN register definitions
 * <table>
 * <caption id="BT_WAKEUP_REMAIN">BT_WAKEUP_REMAIN bitfields</caption>
 * <tr><th>Bits <th>Field Name <th>HW Access <th>SW Access <th>Reset Value
 * <tr><td>31:00 <td>           bt_rsvd <td>R <td>R/W <td>0x0
 * </table>
 *
...
/// Address of the BT_WAKEUP_REMAIN register
#define WCNAON_BT_WAKEUP_REMAIN_ADDR   0x40580050
/// Offset of the BT_WAKEUP_REMAIN register from the base address
#define WCNAON_BT_WAKEUP_REMAIN_OFFSET 0x00000050
/// Index of the BT_WAKEUP_REMAIN register
#define WCNAON_BT_WAKEUP_REMAIN_INDEX  0x00000014
/// Reset value of the BT_WAKEUP_REMAIN register
#define WCNAON_BT_WAKEUP_REMAIN_RESET  0x00000000
 ...
 * @return The current value of the DEEPSLEEP_WAKEUP_IND register.
 */
__INLINE uint32_t wcnaon_bt_wakeup_remain_get(void)
{
    return REG_PL_RD(WCNAON_BT_WAKEUP_REMAIN_ADDR);
}
