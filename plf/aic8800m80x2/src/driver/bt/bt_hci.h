...
/*
 * Register the bt fw idle handler, the handler should be registered before bt_hci_open
 * Host received controller's assert notification
 * @param handler
 *
 */
void bt_fw_idle_irq_handler_register(BT_WAKEUP_IND_IRQ_HANDLER handler);
