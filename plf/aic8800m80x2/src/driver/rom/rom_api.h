...
#define ROM_APITBL_BASE                 ((unsigned int *)(AIC_ROM_BASE + 0x000001A8UL))
#define ROM_FUNC(idx,type)              ((type)ROM_APITBL_BASE[(idx)])

#define ROM_CRC16TBL_BASE               ((unsigned int *)(AIC_ROM_BASE + 0x00000248UL))
#define ROM_CRC32TBL_BASE               ((unsigned int *)(AIC_ROM_BASE + 0x00000448UL))
...
#define ROM_FlashStatusRegRead(args...)     ROM_FUNC(28, unsigned int (*)(unsigned int sr2_exist))(args)
#define ROM_FlashStatusRegWrite(args...)    ROM_FUNC(29, void (*)(unsigned int val, unsigned int msk))(args)
