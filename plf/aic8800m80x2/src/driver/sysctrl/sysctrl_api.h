...
#define EXT_CLK_FREQUENCY_40M       ( 40000000UL)
#define EXT_CLK_FREQUENCY_26M       ( 26000000UL)

#define EXT_CLK_FREQUENCY_2X        (ExtXtalRawClock << 1)
 ...
 * Xtal cap configure
 */
#ifndef CONFIG_XTAL_CAP_VALUE
#define CONFIG_XTAL_CAP_VALUE               0x0F
#endif
#ifndef CONFIG_XTAL_CAP_FINE_VALUE
#define CONFIG_XTAL_CAP_FINE_VALUE          0x00
#endif
...
/**
 * software record pwrctrl irq status, for wakeup source check
 */
extern uint32_t sw_rec_pwrctrl_irqstatus;
...
/**
 * set wifi power close ,not sleep
 */
void pwrctrl_wifi_close(void);
