...
{
    REG_PL_WR(STDIO_UART_IRQCTL_ADDR, (REG_PL_RD(STDIO_UART_IRQCTL_ADDR) & ~((uint32_t)0x00000020)) | (((uint32_t)toirqen << 5) & ((uint32_t)0x00000020)));
}
...
{
    REG_PL_WR(STDIO_UART_DBUFTH_ADDR, (REG_PL_RD(STDIO_UART_DBUFTH_ADDR) & ~((uint32_t)0x00040000)) | (((uint32_t)txtrigth << 18) & ((uint32_t)0x00040000)));
}
