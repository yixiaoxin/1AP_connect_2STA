...
typedef struct {
  ...
  __IO uint32_t                          pmu_xtal_clk_detect0;         //0x00000080
  ...
  __IO uint32_t Reserved_000000AC;                    //0x000000AC
  __IO uint32_t                          dcdc_rf_ctrl4;                //0x000000B0
  __IO uint32_t                          dcdc_core_ctrl4;              //0x000000B4
  __IO uint32_t                          dcdc_common_ctrl;             //0x000000B8
  __IO uint32_t                          pmu_xtal_clk_detect1;         //0x000000BC
} HWP_PMU_RTC1_T;
...
#define PMU_RTC1_RTC_RG_RTC1_POWER_NO_RDY_SET      (1<<26)
#define PMU_RTC1_RTC_RG_RTC1_POWER_NO_RDY_SET_POS  (26)
...
#define PMU_RTC1_RTC_RG_PU_VIO18SENSE      (1<<14)
#define PMU_RTC1_RTC_RG_PU_VIO18SENSE_POS  (14)
#define PMU_RTC1_RTC_RG_EN_SENSE_V33251813      (1<<15)
#define PMU_RTC1_RTC_RG_EN_SENSE_V33251813_POS  (15)
...
//pmu_clk_ctrl1
#define PMU_RTC1_RTC_RG_XTAL_CAP_FINE_BIT(n)      (((n)&0x3F)<<0)
#define PMU_RTC1_RTC_RG_XTAL_CAP_FINE_BIT_LSB     (0)
#define PMU_RTC1_RTC_RG_XTAL_CAP_FINE_BIT_MASK    (0x3F<<0)
...
#define PMU_RTC1_RTC_RG_DCDC_DIS_REDUCE_PGDEADTIME      (1<<27)
#define PMU_RTC1_RTC_RG_DCDC_DIS_REDUCE_PGDEADTIME_POS  (27)
...
#define PMU_RTC1_RTC_RG_VBIT_AON13(n)      (((n)&3)<<8)
#define PMU_RTC1_RTC_RG_VBIT_AON13_LSB     (8)
#define PMU_RTC1_RTC_RG_VBIT_AON13_MASK    (3<<8)
...
//pmu_other_ldo_ctrl1
#define PMU_RTC1_RTC_RG_REG18_ULP_VBIT(n)      (((n)&3)<<0)
#define PMU_RTC1_RTC_RG_REG18_ULP_VBIT_LSB     (0)
#define PMU_RTC1_RTC_RG_REG18_ULP_VBIT_MASK    (3<<0)
...
#define PMU_RTC1_RTC_RG_MSDET_AUTOSW      (1<<14)
#define PMU_RTC1_RTC_RG_MSDET_AUTOSW_POS  (14)
#define PMU_RTC1_RTC_RG_LDO33_BYPASS      (1<<15)
#define PMU_RTC1_RTC_RG_LDO33_BYPASS_POS  (15)
#define PMU_RTC1_RTC_RG_VBIT_VIO18(n)      (((n)&3)<<16)
#define PMU_RTC1_RTC_RG_VBIT_VIO18_LSB     (16)
#define PMU_RTC1_RTC_RG_VBIT_VIO18_MASK    (3<<16)
#define PMU_RTC1_RTC_RG_VBIT_RET(n)      (((n)&0xFF)<<24)
#define PMU_RTC1_RTC_RG_VBIT_RET_LSB     (24)
#define PMU_RTC1_RTC_RG_VBIT_RET_MASK    (0xFF<<24)
...
//pmu_xtal_clk_detect0
#define PMU_RTC1_RTC_RG_CLK_DET_EN      (1<<0)
#define PMU_RTC1_RTC_RG_CLK_DET_EN_POS  (0)
#define PMU_RTC1_RTC_RG_XTAL_DETECT_CLK_SOFT_EN      (1<<1)
#define PMU_RTC1_RTC_RG_XTAL_DETECT_CLK_SOFT_EN_POS  (1)
#define PMU_RTC1_RTC_RG_XTAL_DETECT_SRC_LEN_SEL(n)      (((n)&3)<<2)
#define PMU_RTC1_RTC_RG_XTAL_DETECT_SRC_LEN_SEL_LSB     (2)
#define PMU_RTC1_RTC_RG_XTAL_DETECT_SRC_LEN_SEL_MASK    (3<<2)
#define PMU_RTC1_RTC_RG_CLK_DET_DEST_SEL      (1<<4)
#define PMU_RTC1_RTC_RG_CLK_DET_DEST_SEL_POS  (4)
#define PMU_RTC1_RTC_RG_CLK_DET_SRC_SEL      (1<<5)
#define PMU_RTC1_RTC_RG_CLK_DET_SRC_SEL_POS  (5)
#define PMU_RTC1_RTC_RG_DCDC_CLK_SEL      (1<<6)
#define PMU_RTC1_RTC_RG_DCDC_CLK_SEL_POS  (6)
...
#define PMU_RTC1_RTC_RG_LDO_VFLASH_VBIT33_NOR_TUNE(n)      (((n)&15)<<4)
#define PMU_RTC1_RTC_RG_LDO_VFLASH_VBIT33_NOR_TUNE_LSB     (4)
#define PMU_RTC1_RTC_RG_LDO_VFLASH_VBIT33_NOR_TUNE_MASK    (15<<4)
#define PMU_RTC1_RTC_RG_LDO_VFLASH_VBIT18_NOR_TUNE(n)      (((n)&15)<<8)
#define PMU_RTC1_RTC_RG_LDO_VFLASH_VBIT18_NOR_TUNE_LSB     (8)
#define PMU_RTC1_RTC_RG_LDO_VFLASH_VBIT18_NOR_TUNE_MASK    (15<<8)
...
#define PMU_RTC1_RTC_RG_VFLASH_BYPASS      (1<<18)
#define PMU_RTC1_RTC_RG_VFLASH_BYPASS_POS  (18)
#define PMU_RTC1_RTC_RG_VFLASH_MS_XOR_BOND      (1<<19)
#define PMU_RTC1_RTC_RG_VFLASH_MS_XOR_BOND_POS  (19)
...
#define PMU_RTC1_RTC_RG_DCDC_SINGLE_L_CLOSE_DLY      (1<<31)
#define PMU_RTC1_RTC_RG_DCDC_SINGLE_L_CLOSE_DLY_POS  (31)
...
#define PMU_RTC1_RTC_RG_SW_MON_DLL_MOUT_RF      (1<<7)
#define PMU_RTC1_RTC_RG_SW_MON_DLL_MOUT_RF_POS  (7)
#define PMU_RTC1_RTC_RG_EN_MON_DLL_MOUT      (1<<8)
#define PMU_RTC1_RTC_RG_EN_MON_DLL_MOUT_POS  (8)
#define PMU_RTC1_PMU_DLL_MONT_OUT_RO(n)      (((n)&0x3F)<<9)
#define PMU_RTC1_PMU_DLL_MONT_OUT_RO_LSB     (9)
#define PMU_RTC1_PMU_DLL_MONT_OUT_RO_MASK    (0x3F<<9)
#define PMU_RTC1_RTC_RG_XTAL_CAP_RF_ON_BIT(n)      (((n)&31)<<16)
#define PMU_RTC1_RTC_RG_XTAL_CAP_RF_ON_BIT_LSB     (16)
#define PMU_RTC1_RTC_RG_XTAL_CAP_RF_ON_BIT_MASK    (31<<16)
#define PMU_RTC1_RTC_RG_XTAL_CAP_RF_ON_DELTA(n)      (((n)&0x3F)<<21)
#define PMU_RTC1_RTC_RG_XTAL_CAP_RF_ON_DELTA_LSB     (21)
#define PMU_RTC1_RTC_RG_XTAL_CAP_RF_ON_DELTA_MASK    (0x3F<<21)

//dcdc_rf_ctrl4
#define PMU_RTC1_RTC_RG_DCDC_RF_VBIT_VBP(n)      (((n)&3)<<0)
#define PMU_RTC1_RTC_RG_DCDC_RF_VBIT_VBP_LSB     (0)
#define PMU_RTC1_RTC_RG_DCDC_RF_VBIT_VBP_MASK    (3<<0)
#define PMU_RTC1_RTC_RG_DCDC_RF_VBIT_NM18(n)      (((n)&3)<<2)
#define PMU_RTC1_RTC_RG_DCDC_RF_VBIT_NM18_LSB     (2)
#define PMU_RTC1_RTC_RG_DCDC_RF_VBIT_NM18_MASK    (3<<2)
#define PMU_RTC1_RTC_RG_DCDC_RF_SW_VNM_TOV13      (1<<4)
#define PMU_RTC1_RTC_RG_DCDC_RF_SW_VNM_TOV13_POS  (4)
#define PMU_RTC1_RTC_RG_DCDC_RF_PFAST_DELAY      (1<<5)
#define PMU_RTC1_RTC_RG_DCDC_RF_PFAST_DELAY_POS  (5)
#define PMU_RTC1_RTC_RG_DCDC_RF_NFAST_DELAY      (1<<6)
#define PMU_RTC1_RTC_RG_DCDC_RF_NFAST_DELAY_POS  (6)
#define PMU_RTC1_RTC_RG_DCDC_RF_MORE_P_DELAY      (1<<7)
#define PMU_RTC1_RTC_RG_DCDC_RF_MORE_P_DELAY_POS  (7)
#define PMU_RTC1_RTC_RG_DCDC_RF_MORE_N_DELAY      (1<<8)
#define PMU_RTC1_RTC_RG_DCDC_RF_MORE_N_DELAY_POS  (8)
#define PMU_RTC1_RTC_RG_DCDC_RF_LARGE_I_VBP      (1<<9)
#define PMU_RTC1_RTC_RG_DCDC_RF_LARGE_I_VBP_POS  (9)
#define PMU_RTC1_RTC_RG_DCDC_RF_LARGE_I_NM18      (1<<10)
#define PMU_RTC1_RTC_RG_DCDC_RF_LARGE_I_NM18_POS  (10)
#define PMU_RTC1_RTC_RG_DCDC_RF_EN_FRESP_VBP      (1<<11)
#define PMU_RTC1_RTC_RG_DCDC_RF_EN_FRESP_VBP_POS  (11)
#define PMU_RTC1_RTC_RG_DCDC_RF_EN_FRESP_NM18      (1<<12)
#define PMU_RTC1_RTC_RG_DCDC_RF_EN_FRESP_NM18_POS  (12)
#define PMU_RTC1_RTC_RG_DCDC_RF_EN_DETCLKP      (1<<13)
#define PMU_RTC1_RTC_RG_DCDC_RF_EN_DETCLKP_POS  (13)
#define PMU_RTC1_RTC_RG_DCDC_RF_DLL_PD_OPTION_BYPASS_B      (1<<14)
#define PMU_RTC1_RTC_RG_DCDC_RF_DLL_PD_OPTION_BYPASS_B_POS  (14)
#define PMU_RTC1_RTC_RG_DCDC_RF_DLL_MONT_EN      (1<<15)
#define PMU_RTC1_RTC_RG_DCDC_RF_DLL_MONT_EN_POS  (15)
#define PMU_RTC1_RTC_RG_DCDC_RF_DLL_CAL_OPTION_BYPASS      (1<<16)
#define PMU_RTC1_RTC_RG_DCDC_RF_DLL_CAL_OPTION_BYPASS_POS  (16)

//dcdc_core_ctrl4
#define PMU_RTC1_RTC_RG_DCDC_CORE_VBIT_VBP(n)      (((n)&3)<<0)
#define PMU_RTC1_RTC_RG_DCDC_CORE_VBIT_VBP_LSB     (0)
#define PMU_RTC1_RTC_RG_DCDC_CORE_VBIT_VBP_MASK    (3<<0)
#define PMU_RTC1_RTC_RG_DCDC_CORE_VBIT_NM18(n)      (((n)&3)<<2)
#define PMU_RTC1_RTC_RG_DCDC_CORE_VBIT_NM18_LSB     (2)
#define PMU_RTC1_RTC_RG_DCDC_CORE_VBIT_NM18_MASK    (3<<2)
#define PMU_RTC1_RTC_RG_DCDC_CORE_SW_VNM_TOV13      (1<<4)
#define PMU_RTC1_RTC_RG_DCDC_CORE_SW_VNM_TOV13_POS  (4)
#define PMU_RTC1_RTC_RG_DCDC_CORE_PFAST_DELAY      (1<<5)
#define PMU_RTC1_RTC_RG_DCDC_CORE_PFAST_DELAY_POS  (5)
#define PMU_RTC1_RTC_RG_DCDC_CORE_NFAST_DELAY      (1<<6)
#define PMU_RTC1_RTC_RG_DCDC_CORE_NFAST_DELAY_POS  (6)
#define PMU_RTC1_RTC_RG_DCDC_CORE_MORE_P_DELAY      (1<<7)
#define PMU_RTC1_RTC_RG_DCDC_CORE_MORE_P_DELAY_POS  (7)
#define PMU_RTC1_RTC_RG_DCDC_CORE_MORE_N_DELAY      (1<<8)
#define PMU_RTC1_RTC_RG_DCDC_CORE_MORE_N_DELAY_POS  (8)
#define PMU_RTC1_RTC_RG_DCDC_CORE_LARGE_I_VBP      (1<<9)
#define PMU_RTC1_RTC_RG_DCDC_CORE_LARGE_I_VBP_POS  (9)
#define PMU_RTC1_RTC_RG_DCDC_CORE_LARGE_I_NM18      (1<<10)
#define PMU_RTC1_RTC_RG_DCDC_CORE_LARGE_I_NM18_POS  (10)
#define PMU_RTC1_RTC_RG_DCDC_CORE_EN_FRESP_VBP      (1<<11)
#define PMU_RTC1_RTC_RG_DCDC_CORE_EN_FRESP_VBP_POS  (11)
#define PMU_RTC1_RTC_RG_DCDC_CORE_EN_FRESP_NM18      (1<<12)
#define PMU_RTC1_RTC_RG_DCDC_CORE_EN_FRESP_NM18_POS  (12)
#define PMU_RTC1_RTC_RG_DCDC_CORE_EN_DETCLKP      (1<<13)
#define PMU_RTC1_RTC_RG_DCDC_CORE_EN_DETCLKP_POS  (13)
#define PMU_RTC1_RTC_RG_DCDC_CORE_DLL_PD_OPTION_BYPASS_B      (1<<14)
#define PMU_RTC1_RTC_RG_DCDC_CORE_DLL_PD_OPTION_BYPASS_B_POS  (14)
#define PMU_RTC1_RTC_RG_DCDC_CORE_DLL_MONT_EN      (1<<15)
#define PMU_RTC1_RTC_RG_DCDC_CORE_DLL_MONT_EN_POS  (15)
#define PMU_RTC1_RTC_RG_DCDC_CORE_DLL_CAL_OPTION_BYPASS      (1<<16)
#define PMU_RTC1_RTC_RG_DCDC_CORE_DLL_CAL_OPTION_BYPASS_POS  (16)

//dcdc_common_ctrl
#define PMU_RTC1_RTC_RG_LDO_VPCIE_VBIT(n)      (((n)&15)<<0)
#define PMU_RTC1_RTC_RG_LDO_VPCIE_VBIT_LSB     (0)
#define PMU_RTC1_RTC_RG_LDO_VPCIE_VBIT_MASK    (15<<0)
#define PMU_RTC1_RTC_RG_LDO_VPCIE_ULPMODE      (1<<4)
#define PMU_RTC1_RTC_RG_LDO_VPCIE_ULPMODE_POS  (4)
#define PMU_RTC1_RTC_RG_LDO_VPCIE_PU      (1<<5)
#define PMU_RTC1_RTC_RG_LDO_VPCIE_PU_POS  (5)
#define PMU_RTC1_RTC_RG_LDO_VPCIE_LPMODE      (1<<6)
#define PMU_RTC1_RTC_RG_LDO_VPCIE_LPMODE_POS  (6)
#define PMU_RTC1_RTC_RG_LDO_VPCIE_IBIT(n)      (((n)&7)<<7)
#define PMU_RTC1_RTC_RG_LDO_VPCIE_IBIT_LSB     (7)
#define PMU_RTC1_RTC_RG_LDO_VPCIE_IBIT_MASK    (7<<7)
#define PMU_RTC1_RTC_RG_LDO_VPCIE_CURLIM      (1<<10)
#define PMU_RTC1_RTC_RG_LDO_VPCIE_CURLIM_POS  (10)

//pmu_xtal_clk_detect1
...
#define PMU_RTC1_XTAL_40M_26M_HW_DETECT      (1<<14)
#define PMU_RTC1_XTAL_40M_26M_HW_DETECT_POS  (14)
#define PMU_RTC1_XTAL_DETECT_BUSY       (1<<15)
#define PMU_RTC1_XTAL_DETECT_BUSY_POS   (15)
#define PMU_RTC1_XTAL_CLK_DETECT_DEST_CNT_LATCH(n)      (((n)&0xFFFF)<<16)
#define PMU_RTC1_XTAL_CLK_DETECT_DEST_CNT_LATCH_LSB     (16)
#define PMU_RTC1_XTAL_CLK_DETECT_DEST_CNT_LATCH_MASK    (0xFFFF<<16)
