...
unsigned int pmic_xtal_cap_fine_get(void)
{
    unsigned int reg_val = psim_read((unsigned int)(&AIC_PMU_RTC1->pmu_clk_ctrl1));
    return (reg_val & PMU_RTC1_RTC_RG_XTAL_CAP_FINE_BIT_MASK) >> PMU_RTC1_RTC_RG_XTAL_CAP_FINE_BIT_LSB;
}

void pmic_xtal_cap_fine_set(unsigned int xtal_cap)
{
    psim_mask_write((unsigned int)(&AIC_PMU_RTC1->pmu_clk_ctrl1),
        (PMU_RTC1_RTC_RG_XTAL_CAP_FINE_BIT(xtal_cap)),
        (PMU_RTC1_RTC_RG_XTAL_CAP_FINE_BIT_MASK));
}
...
void pmic_lpmode_init(void)
{
    // 0x70001040
    psim_mask_write((unsigned int)(&AIC_PMU_RTC1->pmu_ldo_vrtc08_ctrl),
        (PMU_RTC1_RTC_RG_LDO_VRTC08_VOSEL_DS_SW(0x8) |
    ...
    // 0x7000103C
    psim_mask_write((unsigned int)(&AIC_PMU_RTC1->pmu_ldo_vcore08_ctrl),
        (PMU_RTC1_RTC_RG_LDO_VCORE08_VOSEL_DS_SW(0xC)),
    ...
    // 0x70001030
    psim_mask_write((unsigned int)(&AIC_PMU_RTC1->pmu_dcdc_rf_ctrl1),
        (PMU_RTC1_RTC_RG_DCDC_RF_VBIT_DS_SW(0x6) |
        PMU_RTC1_RTC_RG_DCDC_RF_VBIT_VOUT_VALLEY_DELTA(0x8)),
    ...
    psim_mask_write((unsigned int)(&AIC_PMU_RTC1->pmu_seq_num0),
        (PMU_RTC1_RTC_RG_LDO_AVDD18_PU_SEQ_NUM(0x0D)),
