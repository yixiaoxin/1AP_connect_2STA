...
#define DUAL_DCDC_CORE_CTRL_RG_DCDC_CLK_SEL_DEEP_SLEEP      (1<<3)
#define DUAL_DCDC_CORE_CTRL_RG_DCDC_CLK_SEL_DEEP_SLEEP_POS  (3)
...
#define DUAL_DCDC_CORE_CTRL_RG_DCDC_ACC_SAT_VTH_DEEP_SLEEP(n)      (((n)&0xFF)<<16)
#define DUAL_DCDC_CORE_CTRL_RG_DCDC_ACC_SAT_VTH_DEEP_SLEEP_LSB     (16)
#define DUAL_DCDC_CORE_CTRL_RG_DCDC_ACC_SAT_VTH_DEEP_SLEEP_MASK    (0xFF<<16)
#define DUAL_DCDC_CORE_CTRL_RG_DCDC_ACC_SAT_VTH(n)      (((n)&0xFF)<<24)
#define DUAL_DCDC_CORE_CTRL_RG_DCDC_ACC_SAT_VTH_LSB     (24)
#define DUAL_DCDC_CORE_CTRL_RG_DCDC_ACC_SAT_VTH_MASK    (0xFF<<24)
...
//dcdc_ctrl_cfg39
#define DUAL_DCDC_CORE_CTRL_RG_DCDC_EN_PMOS(n)      (((n)&0x3F)<<0)
#define DUAL_DCDC_CORE_CTRL_RG_DCDC_EN_PMOS_LSB     (0)
#define DUAL_DCDC_CORE_CTRL_RG_DCDC_EN_PMOS_MASK    (0x3F<<0)
#define DUAL_DCDC_CORE_CTRL_RG_DCDC_EN_NMOS(n)      (((n)&0x3F)<<6)
#define DUAL_DCDC_CORE_CTRL_RG_DCDC_EN_NMOS_LSB     (6)
#define DUAL_DCDC_CORE_CTRL_RG_DCDC_EN_NMOS_MASK    (0x3F<<6)
#define DUAL_DCDC_CORE_CTRL_RG_DCDC_EN_NMOS_PMOS_SW_MODE      (1<<12)
#define DUAL_DCDC_CORE_CTRL_RG_DCDC_EN_NMOS_PMOS_SW_MODE_POS  (12)
