...
/******  Chip Specific Interrupt Numbers **********************************************************/
  ...
  RESERVED0_IRQn                = 30,       /*!< RESERVED Interrupt                               */
  ...
  SDIO_IRQn                     = 64,       /*!< SDIO Interrupt                                   */
  AUD_PROC_IRQn                 = 65,       /*!< Audio Process Interrupt                          */
  TIMER00_IRQn                  = 66,       /*!< Timer Interrupt                                  */
  TIMER01_IRQn                  = 67,       /*!< Timer Interrupt                                  */
  TIMER02_IRQn                  = 68,       /*!< Timer Interrupt                                  */
  TIMER10_IRQn                  = 69,       /*!< Timer Interrupt                                  */
  TIMER11_IRQn                  = 70,       /*!< Timer Interrupt                                  */
  TIMER12_IRQn                  = 71,       /*!< Timer Interrupt                                  */
  PWM_IRQn                      = 72,       /*!< PWM Interrupt                                    */
  GPIOA_IRQn                    = 73,       /*!< GPIOA Interrupt                                  */
  WDT0_IRQn                     = 74,       /*!< WDT Interrupt                                    */
  WDT1_IRQn                     = 75,       /*!< WDT Interrupt                                    */
  SPI_IRQn                      = 76,       /*!< SPI Interrupt                                    */
  PCIE_IRQn                     = 77,       /*!< PCIe Interrupt                                   */
  TRNG_IRQn                     = 78,       /*!< TRNG Interrupt                                   */
  I2CM_IRQn                     = 79,       /*!< I2C Master Interrupt                             */
  SDMMC_IRQn                    = 80,       /*!< SDMMC Interrupt                                  */
  PSIM_IRQn                     = 81,       /*!< PSI Master Interrupt                             */
  CACHE_IRQn                    = 82,       /*!< Cache Interrupt                                  */
  USBDMA_IRQn                   = 83,       /*!< USB DMA Interrupt                                */
  USB20PHY_IRQn                 = 84,       /*!< USB 2.0 PHY Interrupt                            */
  USB30PHY_IRQn                 = 85,       /*!< USB 3.0 PHY Interrupt                            */
  PSRAM_IRQn                    = 86,       /*!< PSRAM Interrupt                                  */
  CM_RF_INTF_IRQn               = 87,       /*!< CM RF Interface Interrupt                        */
  PMU_MSADC_IRQn                = 88,       /*!< PMU MASDC Interrupt                              */
  WF_MSADC_IRQn                 = 89,       /*!< WF MASDC Interrupt                               */
...
#define AIC_WLANROM_BASE      (0x00014000UL)
#define AIC_BTROM_BASE        (0x00080000UL)
#define AIC_RAM0_BASE         (0x00100000UL)
#define AIC_RAM6_BASE         (0x00220000UL)
#define AIC_AUD1K_RAM_BASE    (0x01000000UL)
...
#define AIC_PCIE_EP_BASE      (0x40700000UL)
#define AIC_PCIE_EP_DBI2_BASE (0x40701000UL)
#define AIC_PCIE_CTRL_BASE    (0x40780000UL)
#define AIC_USBC_REG_BASE     (0x40800000UL)
#define AIC_USBC30_BASE       (0x40900000UL)
...
#define AIC_SPIFC_BASE        (AIC_AHB0_BASE + 0x38000)
...
#define AIC_EFUSE_BASE        (AIC_APB0_BASE + 0x0C000)
#define AIC_MSADC_BASE        (AIC_APB0_BASE + 0x0D000)
#define AIC_WF_MSADC_BASE     (AIC_APB0_BASE + 0x0E000)
#define AIC_EFUSE1_BASE       (AIC_APB0_BASE + 0x0F000)
...
#define AIC_PCIE_HOSTDMA_BASE (AIC_AHB2_BASE + 0x42000)
#define AIC_PSRAM_BASE        (AIC_AHB2_BASE + 0x43000)
