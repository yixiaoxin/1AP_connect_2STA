        ...
        case BLE_ADV_PARAM_UPDATE:
            {
                TRACE("ble_adv_param_update interval_min 0x%x, max 0x%x\n",\
                    msg->param.p.adv_param.adv_intv_min,msg->param.p.adv_param.adv_intv_max,msg->param.p.adv_param.max_tx_pwr);
                ble_user_info.adv_param.max_tx_pwr = msg->param.p.adv_param.max_tx_pwr;
...
int app_ble_adv_param_update_msg_send(uint32_t adv_intv_min, uint32_t adv_intv_max,int8_t max_tx_pwr)
{
    APP_BLE_ONLY_MSG msg;
    ...
    msg.param.p.adv_param.max_tx_pwr = max_tx_pwr;
    app_ble_only_msg_send(&msg);
    return 0;
}
