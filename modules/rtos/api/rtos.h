...
enum
{
    ...
    TASK_PRIORITY_HOSTIF               = RTOS_TASK_PRIORITY(3),
    TASK_PRIORITY_HOSTIF_RXDATA        = RTOS_TASK_PRIORITY(3),
    TASK_PRIORITY_NOBLOCK_WIFI         = RTOS_TASK_PRIORITY(1),
    TASK_PRIORITY_SLEEP_IRQ            = RTOS_TASK_PRIORITY(4),
    TASK_PRIORITY_REORDER_TIMER        = RTOS_TASK_PRIORITY(1),
    TASK_PRIORITY_USER_CODE            = RTOS_TASK_PRIORITY(1),
...
enum
{
    ...
    TASK_STACK_SIZE_REORDER_TIMER        = 1024,
    ...
    TASK_STACK_SIZE_HOSTIF               = 512,
    TASK_STACK_SIZE_HOSTIF_RXDATA        = 384,
    TASK_STACK_SIZE_USER_CODE            = 256,
