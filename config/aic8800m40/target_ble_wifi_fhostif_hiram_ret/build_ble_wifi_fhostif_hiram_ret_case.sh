...
python ../../../tools/scons.py -u . PRODUCT=host-wb PLF=aic8800m40 BT=armgcc_4_8 BUILD_CMD="$0 $*" AON=off \
        TGT_MODE=ble_wifi_fhostif_hiram_ret WIFI_HIB=on \
        BT_BLE=on BT_AUDIO=off APPS=on BLE_ONLY=on BT_USER=on TGTNAME=ble_wifi_fhostif_hiram_ret \
        ...
        HEAP_SIZE=0x10000 WIFI_RAM_VER=on \
