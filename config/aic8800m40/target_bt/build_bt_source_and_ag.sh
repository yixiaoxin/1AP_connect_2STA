...
python ../../../tools/scons.py -u . PRODUCT=host-bt PLF=aic8800m40 BT=armgcc_4_8 BUILD_CMD="$0 $*" HW_PLATFORM=asic AON=off \
        TGT_MODE=bt \
        BT_AUDIO=on AUD_USED=on APPS=on a2dp=off A2DP_SOURCE=off HFP_AG=on TGTNAME=bt_source_and_ag CONSOLE=on\
        ROM_VER=auto HEAP_SIZE=0x20000 BT_TESTMODE=on $opt
