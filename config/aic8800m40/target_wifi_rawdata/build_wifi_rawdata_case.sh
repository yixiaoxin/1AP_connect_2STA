...
python ../../../tools/scons.py -u . PRODUCT=host-wifi PLF=aic8800m40 BT=armgcc_4_8 BUILD_CMD="$0 $*" TGT_MODE=wifi_rawdata WIFI_RAM_VER=on PMIC_VER=lite FHOST_APP=rawdata BAND5G=on DPD=off TGTNAME=host_wb_m40_rawdata $opt
