...
python ../../../tools/scons.py -u . PRODUCT=host-wb PLF=aic8800mc BT=armgcc_4_8 BUILD_CMD="$0 $*" AON=off\
        TGT_MODE=btdm_wifi TGTNAME=btdm_wifi_8800mc \
        ...
        A2DP=off A2DP_SOURCE=off HFP_AG=off LINK_ONE=on AUD_USED=off \
		SOFTAP=off CHKSUM=off WIFI_RAM_VER=off HEAP_SIZE=0x20000 FHOST_APP=console $opt
