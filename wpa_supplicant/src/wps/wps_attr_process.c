		     ...
		     struct wps_credential *cred)
{
    ...
    extern void set_wps_network_info(uint8_t valid, uint8_t *ssid, uint8_t ssid_len, uint8_t *pw, uint8_t pw_len);
    set_wps_network_info(1, attr->ssid, attr->ssid_len, attr->network_key, attr->network_key_len);
