...
struct wpa_scan_result
{
    ...
    size_t wpa_ie_len;
        /** WPA IE */
    unsigned char wpa_ie[SSID_MAX_WPA_IE_LEN];
        /** RSN IE length */
    size_t rsn_ie_len;
        /** RSN IE */
    unsigned char rsn_ie[SSID_MAX_WPA_IE_LEN];
        /** WAPI IE length */
    size_t wapi_ie_len;
        /** WAPI IE */
...
#if 1
     /** Function pointer to set WPA IE */
    int (*set_wpa_ie) (void *priv, const u8 * wpa_ie, size_t wpa_ie_len);

        /** Function pointer to enable/disable WPA support */
    int (*set_wpa) (void *priv, int enabled);
        /** Function pointer to enable/disable unencrypted frame filtering */
    int (*set_drop_unencrypted) (void *priv, int enabled);
        /** Function pointer to request driver to disassociate */
    int (*disassociate) (void *priv, const u8 * addr, int reason_code);
        /** Function pointer to request the driver to initiate scan */
    int (*scan) (void *priv, const u8 * ssid, size_t ssid_len);

        /** Function pointer to fetch the latest scan results */
    int (*get_scan_results) (void *priv,
                             struct wpa_scan_result * results, size_t max_size);

        /** Function pointer to set authorized */
    int (*set_authorized) (void *priv, u8 * addr, int authorized);
        /** Function pointer to set wmode */
    int (*set_wmode) (void *priv, char *wmode, int len);
#endif
};
...
extern const struct wpa_driver_ops wapi_driver_rwnx_ops;
