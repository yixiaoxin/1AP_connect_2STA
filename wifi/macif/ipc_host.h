...
////0:  wifi was closed or never initial.    1:  wifi has been initialized, even wifi is sleeping, state always is initialization.
void wifi_init_state_set(int yes);
int wifi_init_state_get(void);
void wifi_fw_powerdown(void);
void wifi_fw_true_powerdown(void);
