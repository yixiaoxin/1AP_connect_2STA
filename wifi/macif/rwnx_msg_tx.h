...
int rwnx_send_arpoffload_en_req(int fvif_idx, u32_l ipaddr,  u8_l enable);
...
int rwnx_send_get_sta_info_req(uint8_t sta_idx,         struct mm_get_sta_info_cfm_new *cfm);
#else
int rwnx_send_get_sta_info_req(uint8_t sta_idx,         struct mm_get_sta_info_cfm *cfm);
#endif
