...
/// IPC EMB2APP tx buf free indication
#define IPC_IRQ_E2A_TXBUF_FREE_IND      CO_BIT(12)
...
#if (PLF_AIC8800M40)
#define IPC_IRQ_WIFI_E2A_MASK_OPT2  (IPC_IRQ_E2A_WIFI_ASSERT_NOTIFY | IPC_IRQ_E2A_TXBUF_FREE_IND)
#else
