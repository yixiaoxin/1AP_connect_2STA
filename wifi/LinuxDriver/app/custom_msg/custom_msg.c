...
char *str_help = "usage: custom_msg vnet0 [mode] <arg1> <arg2> <arg3>\r\n"
                 ...
                 "custom_msg vnet0 13 /your-path/update_app.bin     - host ctrl OTA\r\n"
                 "custom_msg vnet0 14 /your-path/update_fw.bin      - host ctrl OTA\r\n"
                 "custom_msg vnet0 14 xxx.xxx.xxx.xxx               - sync ip to mcu\r\n"
                 "------------------------\r\n"
