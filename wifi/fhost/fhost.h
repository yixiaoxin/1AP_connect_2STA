...
struct rwnx_sta_stats {
    ...
    u32_l last_chan_time;
    u32_l last_chan_busy_time;
    u32_l tx_ack_succ_stat;
    u32_l tx_ack_fail_stat;
    u32_l last_chan_tx_busy_time;
};
/// STA Info Table
struct sta_info_tag
{
...
#define RATE_INFO_BW_20    0  // 20 MHz
#define RATE_INFO_BW_40    1  // 40 MHz
#define RATE_INFO_BW_80    2  // 80 MHz
#define RATE_INFO_BW_160   3  // 160 MHz
 ...
 ****************************************************************************************
 */
uint8_t fhost_vif_get_staid(int fhost_vif_idx, struct mac_addr *dst_addr);
