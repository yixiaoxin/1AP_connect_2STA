...
enum fhost_wpa_event {
     ...
     * - date_type: int
     * - data_value: error type (@ref fhost_wpa_error)
     */
...
/**
 * WPA errors for @ref FHOST_WPA_PROCESS_ERROR \n
 */
 ...
 *
 * Same as @ref fhost_wpa_send_event, except that interface name is provided instead of
 * its index.
 *
 * @param[in] event        WPA event id
 * @param[in] param        Event parameters
 * @param[in] param_len    Length, in bytes, of the parameters
 * @param[in] itf_name     Name of the FHOST interface
 *
